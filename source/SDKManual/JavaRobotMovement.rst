...
.. code-block:: Java
    ...
    * @param   joint_vel  6 target joint velocities, unit deg/s
    * @param   exis_vel  4 external axis velocities, unit deg/s
    * @param   acc  Acceleration percentage, range [0~100], not open yet, default 0
    * @param   vel  Velocity percentage, range [0~100], not open yet, default 0
    * @param   cmdT  Command cycle time, unit s, recommended range [0.001~0.0016]
    * @param   filterT Filter time, unit s, not open yet, default 0
    * @param   gain  Proportional gain for target position, not open yet, default 0
    * @param   id  servoJ command ID, default 0
    * @param   comType Command type; 0-xmlrpc; 1-UDP (corresponding to robot port 20007)
    * @return  Error code
    */
...
.. code-block:: Java
    ...
    * @param  posGain j1~j6 joint position gains
    * @param  desPos j1~j6 joint desired positions, unit: deg
    * @param  velGain j1~j6 joint velocity gains
    * @param  desVel j1~j6 joint desired velocities, unit: deg/s
    * @param  torque_ff j1~j6 feedforward torques, unit: Nm
    * @param  interval Command cycle time, unit s, range [0.001~0.008]
    * @param  comType Command type; 0-xmlrpc; 1-UDP (corresponding to robot port 20007)
    * @return Error code
    */
...
.. code-block:: Java
    ...
    * @param workpieceID Workpiece number [0-14]
