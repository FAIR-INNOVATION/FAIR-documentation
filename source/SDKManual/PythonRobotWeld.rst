...
.. csv-table:: 
    ...
    "Prototype", "``GetWeldMachineCtrlMode(self)``"
    "Description", "Get welding machine control mode"
    "Required Parameters", "
    - ``mode``: Welding machine control mode; 0-DC one-knob mode; 1-pulse one-knob mode; 2-JOB mode; 3-local control mode; 4-separate mode; 5-CC/CV mode; 6-TIG; 7-CMT
    "
    "Default Parameters", "None"
    "Return Value", "Error code, 0-success; non-zero-error" 

Get Welding Machine Control Mode Code Example
++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
.. versionadded:: python SDK-v3.9.8
...
.. csv-table:: 
    ...
    "Prototype", "``GetExtDIConfig(self)``"
    "Description", "Get extended DI function configuration"
    "Required Parameters", "
    - ``DIConfig``: Extended DI input configuration; DIConfig[0]-welding machine ready extended DI port
...
.. csv-table:: 
    ...
    "Prototype", "``GetExtDOConfig(self)``"
    "Description", "Get extended DO function configuration"
    "Required Parameters", "
    - ``DOConfig``: Extended DO output configuration; DOConfig[0]-welding machine arc start extended DO port
...
Get Extended DI/DO Code Example
++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
.. versionadded:: python SDK-V3.9.8
...
.. csv-table:: 
    ...
    "Prototype", "``SetWeaveBackCenterConfig(self, flag)``"
    "Description", "Set whether to return to the cycle zero point at the end of weaving"
    "Required Parameters", "
    - ``flag``: Whether to return to cycle zero point at weave end; 0-do not return; 1-return to cycle zero point
    "
    "Default Parameters", "None"
    "Return Value", "Error code, 0-success; non-zero-error"    
...
.. csv-table:: 
    ...
    "Prototype", "``GetWeaveBackCenterConfig(self)``"
    "Description", "Get the weave end return to cycle zero point parameters"
    "Required Parameters", "
    - ``flag``: Whether to return to cycle zero point at weave end; 0-do not return; 1-return to cycle zero point
    "
    "Default Parameters", "None"
