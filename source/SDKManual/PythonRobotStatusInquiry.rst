...
.. csv-table:: 
    ...
    "Description", "Get tool coordinate system by ID"
    "Required Parameters", "- ``id``: Tool coordinate system number"
    "Default Parameters", "None"
    "Return Value", "
    - Error code, 0-success; non-zero-error
    - ``coord``: Coordinate system values
    - ``type``: Tool type (optional) 0-tool; 1-sensor
    - ``install``: Installation position (optional) 0-robot end; 1-external to robot
    - ``toolID``: Tool ID
    - ``loadNo``: Load number
    "
...
.. csv-table:: 
    ...
    "Description", "Get workpiece coordinate system by ID"
    "Required Parameters", "- ``id``: Workpiece coordinate system number"
    "Default Parameters", "None"
    "Return Value", "
    - Error code, 0-success; non-zero-error
    - ``coord``: Coordinate system values
...
.. csv-table:: 
    ...
    "Description", "Get external tool coordinate system by ID"
    "Required Parameters", "- ``id``: External tool coordinate system number"
    "Default Parameters", "None"
    "Return Value", "
    - Error code, 0-success; non-zero-error
    - ``coord``: Coordinate system values
    - ``tcoord``: Workpiece coordinate system pose mounted on the robot end (6 values: [x, y, z, rx, ry, rz])
    "
...
.. csv-table:: 
    ...
    "Description", "Get extended axis coordinate system by ID"
    "Required Parameters", "- ``id``: Extended axis coordinate system number"
    "Default Parameters", "None"
    "Return Value", "
    - Error code, 0-success; non-zero-error
    - ``coord``: Coordinate system values
