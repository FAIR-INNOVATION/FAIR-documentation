...
.. code-block:: Java
    ...
    /**
    * @brief UDP extended axis parameter acquisition
    * @param  axisID Extended axis number [1-4]
    * @param  params Output parameter array, length 12, order:
    *               [0] axisType Extended axis type 0-linear; 1-rotary
    *               [1] axisDirection Extended axis direction 0-positive; 1-negative
    *               [2] axisMax Extended axis maximum position mm
    *               [3] axisMin Extended axis minimum position mm
    *               [4] axisVel Velocity mm/s
    *               [5] axisAcc Acceleration mm/s²
    *               [6] axisLead Lead mm
    *               [7] encResolution Encoder resolution
    *               [8] axisOffect Weld start point extended axis offset
    *               [9] axisCompany Drive manufacturer 1-Hechen; 2-Inovance; 3-Panasonic
    *               [10] axisModel Drive model
    *               [11] axisEncType Encoder type 0-incremental; 1-absolute
    * @return Error code
    */
