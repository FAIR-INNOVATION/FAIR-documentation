...
.. code-block:: c#
    ...
    * @param [in] idDevice Type, 0-JUNKONG/RYR6T.
    * @param [in] idSoftware Software version, 0-J1.0/HuiDe1.0 (not yet open)
    * @param [in] idBus mount position, 1-end port 1; 2-end port 2.... .8-end port 8 (not yet open)
    * @return Error code
    */
...
.. code-block:: c#
    ...
    * @param [out] idDevice Type, 0-JUNKONG/RYR6T.
    * @return Error code
    */
