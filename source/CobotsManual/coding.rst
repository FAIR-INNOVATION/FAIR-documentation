...
.. centered:: Figure 9.1-3 Contents on the right side of the current program
...
.. centered:: Figure 9.4-1 While command interface
...
.. centered:: Figure 9.5-8 Middle Point 1 of the Circle
...
.. centered:: Figure 9.5-9 The middle point 2 of the circle
...
.. centered:: Figure 9.5-10 Circle movement command addition
...
.. centered:: Figure 9.5-11 Add the starting point of circle motion
...
.. centered:: Figure 9.8-7-1 Weld-Trc command interface-Feedback
...
.. centered:: Figure 9.8-7-2 Weld-Trc command interface-constant
...
.. centered:: Figure 9.8-7-3 Weld-Trc command interface-left and right compensation parameters
...
.. centered:: Figure 9.8-7-4 Short-circuit transition - > half-jet transition- > jet transition
...
.. centered:: Figure 9.8-7-5 The welding gun is above the seam
...
.. centered:: Figure 9.8-7-6 Welding scene
...
Case: As shown in Figure 9.8-7-6, if the "base" or "tool" is selected in the up-down compensation coordinate system, when the workpiece is in the displayed position, the welding gun gradually moves upwards away from the surface of the workpiece when it is not compensated, and it will compensate downward (base coordinate system - Z direction), then the symbol of the up-down compensation coefficients should be a negative sign.
...
.. centered:: Figure 9.18-2 The content on the right side of the current program pops up
...
.. centered:: Figure 9.18-3 Open ModbusTCP Settings
...
.. centered:: Figure 9.18-4 Add "ModbusTCP Master Station
...
.. centered:: Figure 9.18-5 Setting ModbusTCP master station parameters
...
.. centered:: Figure 9.18-6 Connection status of Modbus TCP master station
...
.. centered:: Figure 9.18-7 Add ModbusTCP master station again
...
.. centered:: Figure 9.18-8 Add ModbusTCP master station register
...
.. centered:: Figure 9.18-9 Setting ModbusTCP master station register parameters
...
.. centered:: Figure 9.18-10 Adding Multiple Master Station Registers
...
.. centered:: Figure 9.18-11 Modbus master station address value
...
.. centered:: Figure 9.18-12 Modbus master station displays the values of DI and AI registers
...
.. centered:: Figure 9.18-13 Modbus master station writes DO and AO registers
...
.. centered:: Figure 9.18-14 Refresh the DO and AO address values of ModbusTCP master station.
...
.. centered:: Figure 9.18-15  Open the communication command add page
...
.. centered:: Figure 9.18-16 Select Modbus
...
.. centered:: Figure 9.18-17 Select Modbus_TCP
...
.. centered:: Figure 9.18-18 Selecting Master Station (Client)

.. image:: coding/181.png
   :width: 3in
   :align: center

.. centered:: Figure 9.18-19 ModbusTCP master station command addition
...
.. centered:: Figure 9.18-20 Adding Write Single Digital Output

.. image:: coding/183.png
   :width: 3in
   :align: center

.. centered:: Figure 9.18-21 Apply write a single digital output command
...
.. centered:: Figure 9.18-22 Writing a single coil lua program
...
.. centered:: Figure 9.18-23 Configures writing multiple digital outputs
   
.. image:: coding/186.png
   :width: 3in
   :align: center

.. centered:: Figure 9.18-24 Apply writing multiple digital outputs
...
.. centered:: Figure 9.18-25 Programming multiple coils lua
...
.. centered:: Figure 9.18-26 Configuring Reading a Single Digital Output
      
.. image:: coding/189.png
   :width: 3in
   :align: center

.. centered:: Figure 9.18-27 Applying Reading a Single Digital Output
...
.. centered:: Figure 9.18-28 Program for reading a single coil
...
.. centered:: Figure 9.18-29 Reading a single digital output into a variable
...
.. centered:: Figure 9.18-30 Add motion commands of different points
...
.. centered:: Figure 9.18-31 Move to different points according to different coil values
...
.. centered:: Figure 9.18-32 Read the register value of a single coil and move it
...
.. centered:: Figure 9.18-33 Configuring Reading Multiple Digital Outputs 
         
.. image:: coding/196.png
   :width: 3in
   :align: center

.. centered:: Figure 9.18-34 Applying Reading Multiple Digital Outputs
...
.. centered:: Figure 9.18-35 Reading multiple digital output programs
...
.. centered:: Figure 9.18-36 Reading Multiple Digital Outputs and Storing Variables
...
.. centered:: Figure 9.18-37 Configuring Read Digital Input
            
.. image:: coding/200.png
   :width: 3in
   :align: center

.. centered:: Figure 9.18-38 Applying Read Digital Input
...
.. centered:: Figure 9.18-39 Reading digital input program commands
...
.. centered:: Figure 9.18-40 Reading digital input and storing variables
...
.. centered:: Figure 9.18-41 Reading analog input AI
            
.. image:: coding/204.png
   :width: 6in
   :align: center

.. centered:: Figure 9.18-42 Read and write analog output AO
...
.. centered:: Figure 9.18-43 Add the command of waiting for DI input
...
.. centered:: Figure 9.18-44 Waiting for Digital Input DI Program
...
.. centered:: Figure 9.18-45 Add Waiting for Analog Input
...
.. centered:: Figure 9.18-46 Waiting for AI Input Register Program
...
.. centered:: Figure 9.18-47 Create ModbusTCP slave station user program
...
.. centered:: Figure 9.18-48 The content on the right side of the current program pops up
...
.. centered:: Figure 9.18-49 Open ModbusTCP Settings
...
.. centered:: Figure 9.18-50 ModbusTCP slave settings
...
.. centered:: Figure 9.18-51 slave station connection status indicator light
...
.. centered:: Figure 9.18-52 ModbusTCP slave station coil state monitoring
...
.. centered:: Figure 9.18-53 ModbusTCP slave discrete input control
...
.. centered:: Figure 9.18-54 ModbusTCP slave analog input monitoring
...
.. centered:: Figure 9.18-55 Modbus slave station modifies analog input
...
.. centered:: Figure 9.18-56 Open the communication command add page
...
.. centered:: Figure 9.18-57 Select Modbus
...
.. centered:: Figure 9.18-60 slave command addition
...
.. centered:: Figure 9.18-61 Adding Write Single Digital Output command 
   
.. image:: coding/224.png
   :width: 3in
   :align: center

.. centered:: Figure 9.18-62 Apply Write Single Digital Output command
...
.. centered:: Figure 9.18-63 Write a single digital output LUA program
...
.. centered:: Figure 9.18-64 Configures Writing Multiple Digital Outputs 
      
.. image:: coding/227.png
   :width: 3in
   :align: center

.. centered:: Figure 9.18-65 Apply Write Multiple Digital Outputs
...
.. centered:: Figure 9.18-66 Write multiple digital output LUA programs
...
.. centered:: Figure 9.18-67 Configuring Reading a Single Digital Output 
         
.. image:: coding/230.png
   :width: 3in
   :align: center

.. centered:: Figure 9.18-68 Apply Reading a Single Digital Output
...
.. centered:: Figure 9.18-69 Read a single digital output program
...
.. centered:: Figure 9.18-70 Reading a single digital output into a variable
...
.. centered:: Figure 9.18-71 Add motion commands of different points.
...
.. centered:: Figure 9.18-72 Move to different points according to different digital output values
...
.. centered:: Figure 9.18-73 Read the register value of a single coil and move it
...
.. centered:: Figure 9.18-74 Configures Reading Multiple Digital Outputs
            
.. image:: coding/237.png
   :width: 3in
   :align: center

.. centered:: Figure 9.18-75 Apply Read Multiple Digital Outputs
...
.. centered:: Figure 9.18-76 Reading multiple digital output programs
...
.. centered:: Figure 9.18-77 Reading Multiple Digital Outputs and Storing Variables
...
.. centered:: Figure 9.18-78 Configuring Read Digital Input
               
.. image:: coding/241.png
   :width: 3in
   :align: center

.. centered:: Figure 9.18-79 Applying Read Digital Input
...
.. centered:: Figure 9.18-80 Reading digital input program commands
...
.. centered:: Figure 9.18-81 Reading digital input program
...
.. centered:: Figure 9.18-82 Reading Analog Input
              
.. image:: coding/245.png
   :width: 6in
   :align: center

.. centered:: Figure 9.18-83 Reading and writing analog output
...
.. centered:: Figure 9.18-84 Add the command of waiting for digital input
...
.. centered:: Figure 9.18-85 Waiting for Digital Input Program
...
.. centered:: Figure 9.18-86 Add an command to wait for analog input
...
.. centered:: Figure 9.18-87 Waiting for Analog Input Register Program
...
.. centered:: Figure 9.18-88 Digital Input of Robot Slave Station Function
...
.. centered:: Figure 9.19-1 Teaching management interface-system mode
...
.. centered:: Figure 9.19-2 Teaching management interface-point table mode
...
.. centered:: Figure 9.19-3 Teach point details
...
.. centered:: Figure 9.19-4 Run teach point